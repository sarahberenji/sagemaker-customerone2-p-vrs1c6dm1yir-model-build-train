...
def convert_to_pandas(data, pandas_params, spine_params, target_col, data_dictionary, features, ref_date, ref_period):
    ...
    print(f"Sarah utils.convert_to_pandas() > data.shape = {data.shape}")
    print(f"Sarah utils.convert_to_pandas() > pandas_params={pandas_params}")
    print(f"Sarah utils.convert_to_pandas() > spine_params={spine_params}")
    print(f"Sarah utils.convert_to_pandas() > target_col={target_col}")
    print(f"Sarah utils.convert_to_pandas() > data_dictionary={data_dictionary}")
    print(f"Sarah utils.convert_to_pandas() > ref_date={ref_date}")
    print(f"Sarah utils.convert_to_pandas() > ref_period={ref_period}")
