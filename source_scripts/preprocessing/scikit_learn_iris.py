...
def train(train=None, test=None):
    ...
    """
    print("SARAH: scikit_learn_iris.py in preprocessing folder > train()")
...
def evaluate(test=None, model=None):
    """Evaluates the performance for the given model.
       ...
       Args:
          test: location on the filesystem for test dataset 
    """
    print("SARAH: scikit_learn_iris.py in preprocessing folder > evaluate()")
    if test:
...
if __name__ == '__main__':
    ...
    print("SARAH: scikit_learn_iris.py in preprocessing folder > __main__")
...
def model_fn(model_dir):
    ...
    """
    print("SARAH: scikit_learn_iris.py in preprocessing folder > model_fn()")
