...
def train(train=None, 
    ...
    """
    print("SARAH: cross_validation_with_hpo.py in preprocessing folder > train() ")
    ...
    print(f"SARAH: cross_validation_with_hpo.py in preprocessing folder > train() image_uri={image_uri}")
    print(f"SARAH: cross_validation_with_hpo.py in preprocessing folder > train() instance_type={instance_type}")
    print(f"SARAH: cross_validation_with_hpo.py in preprocessing folder > train() instance_count={instance_count}")
    print(f"SARAH: cross_validation_with_hpo.py in preprocessing folder > train() output_path={output_path}")
